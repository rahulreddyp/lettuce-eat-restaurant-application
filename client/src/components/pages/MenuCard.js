...
const MenuCard = ({ item, isAdmin }) => {
    ...
    var CardImage = (item.photo !== "") ? `${API}/menu/photo/${item._id}`: item.alt_photo;
  ...
  const deleteConfirmationMessage = () => (
    <div className="alert alert-prompt alert-dismissable fade show" role="alert">     
  ...
  return (          
    ...
    <div className="card shadow">
        <Fragment>
          {deleteItem ? deleteConfirmationMessage(): null }
        </Fragment>
      <div onClick={()=>{redirectToItemDetails()}}>
